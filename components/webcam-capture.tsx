...
export function WebcamCapture({ onCapture }: WebcamCaptureProps) {
  ...
  return (
    <div className="flex flex-col items-center space-y-4 w-full">
      {/* Larger Camera Frame */}
      <div className="relative w-full rounded-xl overflow-hidden bg-black shadow-md transition-all duration-300 hover:shadow-lg">
        <Webcam
          audio={false}
          ref={webcamRef}
      ...
      <Button
        ...
        disabled={isLoading}
        className="w-full bg-blue-600 hover:bg-blue-700 text-white h-14 text-lg font-medium transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98]"
